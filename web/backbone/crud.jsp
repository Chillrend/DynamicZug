            ...
            <section class="card card-cascade narrower mb-5">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        ...
                        <!--Panel Header-->
                        <div class="view py-3 gradient-card-header deus">
                            <h5 class="mb-0">Deutsche Bahn Sales</h5>
                        </div>
                        <!--/Panel Header-->
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4 text-center">
                                    ...
                                    <!--Summary-->
                                    <p>Today Income:<br>
                                        <strong>â¬ : <span style="color:red">800000</span></strong>
                                    ...
                                    <p>Target Income:<br>
                                        <strong>â¬ : 1000000</strong>

                                    </p>

                                    <!--Change chart-->

                                    <span class="min-chart my-4" id="chart-sales" data-percent="80">
                    ...
                    <div class="col-md-7">
                        ...
                        <!--Panel Header-->
                        <div class="view py-3 gradient-card-header info-color-dark mb-4">
